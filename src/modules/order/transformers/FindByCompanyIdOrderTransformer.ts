...
@singleton()
export class FindByCompanyIdOrderTransformer {
  public fromApi(request?: FastifyRequest<{ Params: FindByCompanyIdOrderParamsRequest; Querystring: FindByCompanyIdOrderQueryRequest }>): FindByCompanyIdOrderInputDTO {
  ...
  public toApi(outputDTO: FindByCompanyIdOrderOutputDTO): FindByCompanyIdOrderResponse {
    return {
