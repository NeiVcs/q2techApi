...
export const DeleteOrderSchema = schema.raw;
export type DeleteOrderParamsRequest = typeof schema.types.params;
export type DeleteOrderResponse = (typeof schema.types.response)[204];
