...
const schema = createSchema({
  description: 'Delete a table status.',
...
export const DeleteTableStatusSchema = schema.raw;
export type DeleteTableStatusParamsRequest = typeof schema.types.params;
export type DeleteTableStatusResponse = (typeof schema.types.response)[204];
