...
import { createCompanyController, deleteCompanyController, findAllCompanyController, findByIdCompanyController, findByUrlCompanyController, updateCompanyController } from ".";
