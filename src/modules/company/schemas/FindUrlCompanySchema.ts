...
export const FindByUrlCompanySchema = schema.raw;
export type FindByUrlCompanyParamsRequest = typeof schema.types.params;
export type FindByUrlCompanyResponse = (typeof schema.types.response)[200];
